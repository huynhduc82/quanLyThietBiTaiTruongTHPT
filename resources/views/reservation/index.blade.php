    ...
    <div class="container-fluid py-4">
        <div class="row">
            <form role="form text-left" class="w-70" >
                ...
                <div class="mb-3">
                    <p>Mã phòng</p>
                    <input type="text" class="form-control" placeholder="Mã phòng" aria-label="Mã phòng" >
                </div>
                <div class="mb-3">
                    <p>Mã giáo viên</p>
                    <input type="text" class="form-control" placeholder="Mã giáo viên" aria-label="Mã giáo viên" >
                </div>
                <div class="mb-3">
                    <p>Ngày Mượn</p>
                            ...
                            <div class="card-body px-0 pt-0 pb-2">
                                <div class="table-responsive p-0">
                                    <table class="table align-items-center justify-content-center mb-0">
                                        <thead>
                                        <tr>
                                            <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-20">Mã giáo viên</th>
                                            <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-20 ps-2">Thiết bị</th>
                                            <th class="text-uppercase text-secondary text-xxs font-weight-bolder text-center opacity-20 ps-2">Mã phòng</th>
                                            <th class="text-uppercase text-secondary text-xxs font-weight-bolder text-center opacity-20 ps-2">Ngày đặt </th>
                                        </tr>
                                        </thead>
                                        <tr>
