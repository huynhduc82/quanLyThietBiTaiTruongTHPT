                        ...
                        <ul class="nav nav-pills nav-fill p-1 bg-transparent" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link mb-0 px-0 py-1 active " data-bs-toggle="tab" href="javascript:;" role="tab" aria-selected="true">
                                    ...
                                    <span class="ms-1">Thông tin</span>
                                </a>
                            </li>
                            <li class="nav-item">
    ...
    <div class="container-fluid py-4">
        <div class="row">
            ...
            <div class="col-12 col-xl-4">
                <div class="card h-100">
                    <div class="card-header pb-0 p-3">
                        <h6 class="mb-0">Nhân viên khác</h6>
                    </div>
                    <div class="card-body p-3">
                        <ul class="list-group">
                            <li class="list-group-item border-0 d-flex align-items-center px-0 mb-2">
                                ...
                                <div class="d-flex align-items-start flex-column justify-content-center">
                                    ...
                                    <p class="mb-0 text-xs">Hi! Kết bạn với mình nhé</p>
                                </div>
                                <a class="btn btn-link pe-3 ps-0 mb-0 ms-auto" href="javascript:;">Xem thông tin.</a>
                            </li>
            ...
            <div class="col-12 mt-4">
                <div class="card mb-4">
                    <div class="card-header pb-0 p-3">
                        <h6 class="mb-1">Chuyên ngành</h6>
                        <p class="text-sm">Các môn giảng dạy</p>
                    </div>
                    <div class="card-body p-3">
                        <div class="row">
                                ...
                                <div class="card h-100 card-plain border">
                                    <div class="card-body d-flex flex-column justify-content-center text-center">
                                        <a href="javascript:;">
                                            ...
                                            <h5 class=" text-secondary"> Thêm </h5>
                                        </a>
                                    </div>
                                </div>
                            </div>
