            ...
            <div class="col-12">
                <div class="card mb-4">
                    <div class="card-header pb-0">
                        <h2>Quản lý số lượng thiết bị</h2>
                    </div>
                    <form id="frm-filter" action="{{ route('number.search-by-name') }}" method="GET">
