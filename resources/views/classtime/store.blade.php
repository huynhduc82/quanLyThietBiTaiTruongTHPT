                ...
                <form id="frm-class-time">
                    <div class="form-group px-4">
                        <div class="col-9">
                            ...
                            <input type="text" class="form-control" placeholder="Bài học" id="lesson">
                        </div>
                    </div>
                    <div class="form-group px-4">
                        <div class="col-9">
                            <label class="col-form-label">Thời gian bắt đầu</label>
                            <input type="time" class="form-control" placeholder="Thời gian bắt đầu" id="start">
                        </div>
                    </div>
                    <div class="form-group px-4">
                        <div class="col-9">
                            <label class="col-form-label">Thời gian kết thúc</label>
                            <input type="time" class="form-control" placeholder="Thời gian kết thúc" id="end">
                        </div>
                    </div>
...
@section('footer_scripts')
    ...
    <script type="text/javascript" src="{{ asset('core/js/class_time/class_time_store.js')}}"></script>
    <script>
